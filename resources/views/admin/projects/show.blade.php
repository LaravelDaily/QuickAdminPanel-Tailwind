...
<div class="max-w w-full bg-white shadow-md rounded-md overflow-hidden border">
    <div class="flex justify-between items-center px-5 py-3 text-gray-700 border-b">
        <h3 class="text-sm">{{ trans('global.show') }} {{ trans('cruds.project.title') }}</h3>
    </div>

    <div class="px-5 py-6 bg-gray-200 text-gray-700 border-b">
        <div class="block pb-4">
            <a class="inline-block px-3 py-2 rounded-sm text-sm focus:outline-none mx-1 bg-gray-300 hover:bg-gray-400 text-black" href="{{ route('admin.projects.index') }}">
